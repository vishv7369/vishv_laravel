					...
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									<form action="{{url('/edit-mr/'.$fetch->id)}}" method="post" enctype="multipart/form-data">
										@csrf
										<div class="row">
											<div class="col-xl-6">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="file" class="form-control" name="profile_img" value="{{asset('upload/mr/'.$fetch->profile_img)}}">
														<img src="{{asset('upload/mr/'.$fetch->profile_img)}}" height="50px" width="50px">
													</div>
												</div>
												<div class="form-group row">
