											...
											<tbody>
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="{{url('/admin-profile')}}" class="avatar avatar-sm mr-2">
																<img class="avatar-img" src="{{url('/Backend/assets/img/specialities/specialities-01.png')}}" alt="Speciality">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="{{url('/admin-profile')}}" class="avatar avatar-sm mr-2">
																<img class="avatar-img" src="{{url('/Backend/assets/img/specialities/specialities-02.png')}}" alt="Speciality">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="{{url('/admin-profile')}}" class="avatar avatar-sm mr-2">
																<img class="avatar-img" src="{{url('/Backend/assets/img/specialities/specialities-03.png')}}" alt="Speciality">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="{{url('/admin-profile')}}" class="avatar avatar-sm mr-2">
																<img class="avatar-img" src="{{url('/Backend/assets/img/specialities/specialities-04.png')}}" alt="Speciality">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="{{url('/admin-profile')}}" class="avatar avatar-sm mr-2">
																<img class="avatar-img" src="{{url('/Backend/assets/img/specialities/specialities-05.png')}}" alt="Speciality">
															</a>
