							...
							<div class="profile-header">
								<div class="row align-items-center">
									<div class="col-auto profile-image">
										<a href="#">
											<img class="rounded-circle" style="height:100px;width:100px;" src="{{asset('upload/mr/'.$fetch->mrprofile_img)}}">
										</a>
									</div>
												...
												<div class="modal-dialog modal-dialog-centered" role="document" >
													<div class="modal-content">
														...
														<div class="modal-body">
															<form action="{{url('/mr-profile/'.$fetch->id )}}" method="post" enctype="multipart/form-data">
															@csrf	
															<div class="row form-row">
																	...
																	<div class="col-12 ">
																		<div class="form-group">
                                                        					...
                                                        					<img src="{{asset('upload/mr/'.$fetch->mrprofile_img)}}" height="70px" width="70px">
																		</div>
																	</div>
