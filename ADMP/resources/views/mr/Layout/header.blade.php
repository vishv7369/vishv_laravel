            ...
            <div class="header">
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown has-arrow">
						<a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
							<span class="user-img"><img class="rounded-circle" src="{{url('upload/mr/'. Session('mrprofile_img'))}}" width="31" alt="Ryan Taylor"></span>
						</a>
						<div class="dropdown-menu">
							<div class="user-header">
								<div class="avatar avatar-sm">
									<img src="{{url('upload/mr/'. Session('mrprofile_img'))}}" alt="User Image" class="avatar-img rounded-circle">
								</div>
								<div class="user-text">
									<h6>{{Session('mrname')}}</h6>
									<p class="text-muted mb-0">Administrator</p>
								</div>
							</div>
							<a class="dropdown-item" href="{{url('/mr-profile')}}">My Profile</a>
							<a class="dropdown-item" href="{{url('/mr-changepassword')}}">Change Password</a>
							<a class="dropdown-item" href="{{url('/mrlogout')}}">Logout</a>
						</div>
					</li>
					<!-- /User Menu -->
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="active"> 
								<a href="{{url('/mr-dashboard')}}"><i class="fe fe-home"></i> <span>Dashboard</span></a>
							</li>

							

							<li> 
								<a href="{{url('/mr-medicine-mr')}}"><i class="fe fe-plus"></i> <span>Medicine</span></a>
							</li>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li>
											<a href="{{url('/mr-doctor')}}"><i class="fe fe-user"></i> <span>Manage Doctors</span></a>
									</li>
									<li>
											<a href="{{url('/mr-fav-doctor')}}"><i class="fe fe-user"></i> <span>My Doctors</span></a>
									</li>		
								</ul>
							</li>
