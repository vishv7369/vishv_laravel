							...
							<div class="card-body">
								<div class="row">
									...
									<div class="col-md-5 col-lg-5">
										...
										@endif
										<form action="{{url('/mraddmedicine')}}" method="post" enctype="multipart/form-data">
											@csrf
										...
										@endif
												<div class="table-responsive">
													<table class="datatable table table-hover table-center mb-0">
														...
														<tbody>
															@if(!$medicine_mr->isEmpty())
											                @foreach($medicine_mr as $medicine_mr)
															<tr>
																<td><?php echo $medicine_mr->id?></td>
																<td><?php echo $medicine_mr->medicine_name?></td>
																<td class="text-right">
																	<div class="actions">
																		<a  href="{{url('mraddmedicine/'. $medicine_mr->id)}}" class="btn btn-sm bg-danger-light">
