				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="col-md-12 col-lg-12 col-xl-12">
							...
							@if(!$mrfavdoctor_arr->isEmpty())
							@foreach($mrfavdoctor_arr as $data)
								...
								<div class="col-md-6 col-lg-4 col-xl-3">
									<div class="card widget-profile pat-widget-profile">
										<div class="card-body">
											...
											@endphp	
											@if(!$slot_mr_arr->isEmpty())
											<form action="{{url('/mr_app_book')}}" method="post" enctype="multipart/form-data">
												@csrf
											@foreach($slot_mr_arr as $slots)
