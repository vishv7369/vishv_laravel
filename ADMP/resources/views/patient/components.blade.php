							...
							<div class="row">
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="avatar avatar-xxl">
												<img class="avatar-img rounded-circle" alt="User Image" src="{{url('Frontend/assets/img/patients/patient8.jpg')}}">
											</div>
								...
								<div class="col-md-12">
									<div class="card">
										...
										<div class="card-body">
											<div class="avatar">
												<img class="avatar-img rounded" alt="User Image" src="{{url('Frontend/assets/img/patients/patient8.jpg')}}">
											</div>
											<div class="avatar">
												<img class="avatar-img rounded-circle" alt="User Image" src="{{url('Frontend/assets/img/patients/patient8.jpg')}}">
											</div>
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="avatar-group">
												<div class="avatar">
													<img class="avatar-img rounded-circle border border-white" alt="User Image" src="{{url('Frontend/assets/img/patients/patient8.jpg')}}">
												</div>
												<div class="avatar">
													<img class="avatar-img rounded-circle border border-white" alt="User Image" src="{{url('Frontend/assets/img/patients/patient2.jpg')}}">
												</div>
												<div class="avatar">
													<img class="avatar-img rounded-circle border border-white" alt="User Image" src="{{url('Frontend/assets/img/patients/patient3.jpg')}}">
												</div>
												<div class="avatar">
							...
							<div class="row">
								<div class="col-12 col-md-6 col-lg-4 d-flex">
									<div class="card flex-fill">
										<img alt="Card Image" src="{{url('Frontend/assets/img/img-01.jpg')}}" class="card-img-top">
										<div class="card-header">
...
<!-- doccure/{{url('/components')}}  30 Nov 2019 04:12:19 GMT -->
</html>
@endsection