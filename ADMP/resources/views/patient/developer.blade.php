										...
										<div class="card-body">
											<div class="pro-widget-content">
												...
												<a href="#" class="booking-doc-img">
														<img src="{{url('Frontend/assets/img/specialities/d/mohini.jpeg')}}" alt="User Image">
													</a>
									...
									<div class="card widget-profile pat-widget-profile">
										<div class="card-body">
											<div class="pro-widget-content">
												<div class="profile-info-widget">
												<a href="#" class="booking-doc-img">
														<img src="{{url('Frontend/assets/img/specialities/d/vishv.jpeg')}}" alt="User Image">
													</a>
													<div class="profile-det-info">
									...
									<div class="card widget-profile pat-widget-profile">
										<div class="card-body">
											<div class="pro-widget-content">
												<div class="profile-info-widget">
												<a href="#" class="booking-doc-img">
														<img src="{{url('Frontend/assets/img/specialities/d/reena.jpeg')}}" alt="User Image">
													</a>
													<div class="profile-det-info">
