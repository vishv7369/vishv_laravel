                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2">
                                    <div class="img-thumbnail float-right"><img src="{{url('Backend/Admin/assests/img/logo-dark.png')}}" alt="" width="40" height="40"></div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2">
                                    <div class="settings-image img-thumbnail float-right"><img src="{{url('Backend/Admin/assests/img/favicon.ico')}}" class="img-fluid" width="16" height="16" alt=""></div>
                                </div>
                            </div>
