...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('Backend/Admin/assets/css/dataTables.bootstrap4.min.css/')}}">
...
<body>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                <div class="sidebar-menu">
                    <ul>
                        <li>
                            <a href="index-2"><i class="fa fa-home back-icon"></i> <span>Back to Home</span></a>
                        </li>
                        ...
                        <div class="card-box">
                                ...
                                <div class="mailview-header">
                                    ...
                                    <div class="sender-info">
                                        <div class="sender-img">
                                            <img width="40" alt="" src="{{url('Backend/Admin/assets/img/user.jpg/')}}" class="rounded-circle">
                                        </div>
                            ...
                            <div class="mail-attachments">
                                ...
                                <ul class="attachments clearfix text-center">
                                    ...
                                    <li>
                                        <div class="attach-file"><img src="{{url('Backend/Admin/assets/img/placeholder.jpg/')}}" alt="Attachment"></div>
                                        <div class="attach-info">
    ...
    <script src="{{url('Backend/Admin/assets/js/jquery.dataTables.min.js"></script>
    <script src="{{url('Backend/Admin/assets/js/dataTables.bootstrap4.min.js"></script>
    <script src="{{url('Backend/Admin/assets/js/jquery.slimscroll.js"></script>
