      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <?php
					...
					?>  
					  <tr>
            <td><?php echo $data->drone_type_id?></td>
            <td><img src="upload/drone/<?php echo $data->drone_img?>" width="50px" height="50px"></td>
						<td><?php echo $data->drone_type?></td>
            <td><?php echo $data->description?></td>
            <td><?php echo $data->created_dt?>/<?php echo $data->updated_dt?></td>
						<td><a href="delete?del_drone_type_id=<?php echo $data->drone_id?>" class="btn btn-danger">Delete</a></td>
