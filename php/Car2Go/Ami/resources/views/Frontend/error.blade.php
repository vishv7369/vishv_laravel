...
<!-- Acto/error.php  13 Nov 2019 13:11:05 GMT -->
<head>
<meta charset="utf-8">
...
<body class="boxed_wrapper">
    ...
    <!-- error-section -->
    <section class="error-section centred" style="background-image: url({{url('Frontend/images/background/error-bg.jpg')}});">
        <div class="container">
            <div class="content-box">
                <h1 class="error-title">404</h1>
                <h2>Oops! Something went wrong</h2>
                <div class="text">We're not being able to find the page you're looking for</div>
                <div class="btn-box"><a href="index-2.php"><i class="fas fa-angle-left"></i>Go back Home</a></div>
                <figure class="image-box"><img src="{{url('Frontend/images/resource/wheel-2.png')}}" alt=""></figure>
            </div>
        </div>
    </section>
    <!-- error-section end -->
...
<!-- Acto/error.php  13 Nov 2019 13:11:06 GMT -->
</html>
