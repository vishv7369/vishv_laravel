...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('Backend/Admin/assets/css/fullcalendar.min.css/')}}">
...
<body>
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            ...
                            <ul style="display: none;">
                                ...
                                <li><a class="active" href="form-vertical">Vertical Form</a></li>
                            </ul>
                        </li>
                        <li class="submenu">
    ...
    <script src="{{url('Backend/Admin/assets/js/select2.min.js"></script>
