                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li class="submenu">
							...
							<li><a href="admin-addcategory"></i> <span>Add Category</span></a></li>
						...
						<li class="submenu">
                            ...
                            <ul style="display: none;">
							<li><a href="admin-addproduct"></i> <span>Add Product</span></a></li>
						...
						<li class="submenu">
                            ...
                            <ul style="display: none;">
							<li><a href="admin-login"></i> <span>Login</span></a></li>
						    <li><a href="admin-register"></i> <span>Register</span></a></li>
