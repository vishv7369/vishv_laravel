                ...
                <div class="row">
                    ...
                    <div class="col ">
                        <div class="blog-item" style="margin-left:440px;">
                            <div class="blog-img">
                                <img src="../Admin/upload/employee/<?php echo $fetch->Profile_img;?>" style="width:35%; border-radius:50%; height:250px" align="center" alt="">
							...
							<a href="edit_user?btn_Employee_id=<?php echo $fetch->Employee_id;?>"  ><p>Edit Profile</p></a>
                           </button>
                        </div>
                    </div>
