							...
							<div class="row">
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="avatar avatar-xxl">
												<img class="avatar-img rounded-circle" alt="User Image" src="{{url('/Backend/assets/img/profiles/avatar-02.jpg')}}">
											</div>
								...
								<div class="col-md-12">
									<div class="card">
										...
										<div class="card-body">
											<div class="avatar">
												<img class="avatar-img rounded" alt="User Image" src="{{url('/Backend/assets/img/profiles/avatar-02.jpg')}}">
											</div>
											<div class="avatar">
												<img class="avatar-img rounded-circle" alt="User Image" src="{{url('/Backend/assets/img/profiles/avatar-02.jpg')}}">
											</div>
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="avatar-group">
												<div class="avatar">
													<img class="avatar-img rounded-circle border border-white" alt="User Image" src="{{url('/Backend/assets/img/profiles/avatar-02.jpg')}}">
												</div>
												<div class="avatar">
													<img class="avatar-img rounded-circle border border-white" alt="User Image" src="{{url('/Backend/assets/img/profiles/avatar-03.jpg')}}">
												</div>
												<div class="avatar">
													<img class="avatar-img rounded-circle border border-white" alt="User Image" src="{{url('/Backend/assets/img/profiles/avatar-04.jpg')}}">
												</div>
												<div class="avatar">
							...
							<div class="row">
								<div class="col-12 col-md-6 col-lg-4 d-flex">
									<div class="card flex-fill">
										<img alt="Card Image" src="{{url('/Backend/assets/img/img-01.jpg')}}" class="card-img-top">
										<div class="card-header">
									...
									<div>
										<ul class="pagination">
											<li class="page-item disabled">
												<a class="page-link" href="#" tabadmin="-1">Previous</a>
											</li>
...
<!-- Mirrored from dreamguys.co.in/demo/doccure/admin/{{url('/admin-components')}} by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 Nov 2019 04:12:54 GMT -->
</html>
