	...
	.attachments li {
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="card-box bg-color">
                            <h4 class="payslip-title">Payslip for the Drone</h4>
                            <div class="row">
                                <div class="col-sm-6 m-b-20">
                                    <img src="assets/img/logo/logo.png" class="inv-logo" alt="">
                            ...
                            <div class="row">
                                <div class="col-sm-10">
                                    <div>
                                        ...
                                        <table class="table table-bordered col-sm-10">
                                            <tbody>
                                                <tr>
                                                    <td><strong>product name</strong> <span class="float-right">$6500</span></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>product quantity</strong> <span class="float-right">$55</span></td>
                                                </tr>
                                                <tr>
                                                    <td><strong><b>Total</b></strong> <span class="float-right"><strong><b>$55</b></strong></span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <p align="center">Thank You For Choosing Us.</p>
                                </div>
                            </div>
                        </div>
                    </div>
