  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="../../index2.php"><b>Client</b>Login</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
        <form  method="post" action="">
          <div class="form-group has-feedback">
            <input type="text" name="User_name"  value="<?php if(isset($_COOKIE['User_name'])){ echo $_COOKIE['User_name'];}?>" class="form-control" placeholder="User_name"/>
