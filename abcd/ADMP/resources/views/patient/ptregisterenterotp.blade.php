								...
								<div class="row align-items-center justify-content-center">
									...
									<div class="col-md-12 col-lg-6 login-right">
										<div class="login-header">
											<h3>Enter OTP to Conform your Registration</h3>
											<p class="small text-muted"><a href="">Resend OTP</a></p>
										</div>
										
										<!-- Forgot Password Form -->
										<form action="{{url('/match_register_otp')}}" method="post" enctype="multipart/form-data">
											@csrf
											<div class="form-group form-focus">
												<input type="text" name="registerotp" class="form-control floating">
												<label class="focus-label">Enter OTP</label>
												@if ($errors->has('registerotp'))
            										<span class="text-danger">{{ $errors->first('registerotp') }}</span>
       											@endif
											</div>
