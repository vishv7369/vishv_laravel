							...
							<div class="profile-header">
								<div class="row align-items-center">
									<div class="col-auto profile-image">
										<a href="#">
											<img class="rounded-circle" style="height:100px;width:100px;" src="{{asset('upload/manager/'.$fetch->mprofile_img)}}">
										</a>
									</div>
									<div class="col ml-md-n2 profile-user-info">
										...
										<h6 class="text-muted"><?php echo $fetch->Manager_name;?></h6><br>
										</div>	
									<div class="col ml-md-n2 profile-user-info">
												...
												<div class="modal-dialog modal-dialog-centered" role="document" >
													<div class="modal-content">
														...
														<div class="modal-body">
															<form action="{{url('/manager-profile/'.$fetch->id )}}" method="post" enctype="multipart/form-data">
															@csrf	
															<div class="row form-row">
																	...
																	<div class="col-12 ">
																		<div class="form-group">
                                                        					...
                                                        					<img src="{{asset('upload/manager/'.$fetch->mprofile_img)}}" height="70px" width="70px">
																		</div>
																	</div>
